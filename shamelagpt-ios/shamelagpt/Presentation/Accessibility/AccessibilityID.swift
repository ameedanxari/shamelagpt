...
enum AccessibilityID {
    ...
    enum Chat {
        ...
        static let shareButton = "chatShareButton"
        static let sharePopover = "chatSharePopover"
        static let shareToggle = "chatShareToggle"
        static let shareCopyLinkButton = "chatShareCopyLinkButton"
        static let typingIndicator = "TypingIndicator"
        static let thinkingBubble = "ThinkingBubble"
        static let reasoningPanel = "ReasoningPanel"
        static let reasoningPanelToggle = "ReasoningPanelToggle"
        static let reasoningPanelBody = "ReasoningPanelBody"
