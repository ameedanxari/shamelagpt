...
enum NetworkError: LocalizedError, Equatable {
    ...
    var userMessageWithCode: String {
        // Localize the message key and append debug code for user-facing support messages
        let localized = NSLocalizedString(userMessage, comment: "")
        return "\(localized) (\(debugCode))"
    }
