...
enum LocalizationKeys {
    ...
    static let chatReasoningTitle = "chat.reasoning.title"
    static let chatReasoningShow = "chat.reasoning.show"
    static let chatReasoningHide = "chat.reasoning.hide"
    ...
    static let chatWarningModePreferenceNotSaved = "chat.warning.modePreferenceNotSaved"
    ...
    // School of thought (madhhab) preference
    static let madhabTitle = "settings.madhab.title"
    static let madhabTitleArabic = "settings.madhab.titleArabic"
    static let madhabHelp = "settings.madhab.help"
    static let madhabAll = "settings.madhab.all"
    static let madhabAllArabic = "settings.madhab.allArabic"
    static let madhabAllDescription = "settings.madhab.allDescription"
    static let madhabHanafi = "settings.madhab.hanafi"
    static let madhabHanafiArabic = "settings.madhab.hanafiArabic"
    static let madhabHanafiDescription = "settings.madhab.hanafiDescription"
    static let madhabMaliki = "settings.madhab.maliki"
    static let madhabMalikiArabic = "settings.madhab.malikiArabic"
    static let madhabMalikiDescription = "settings.madhab.malikiDescription"
    static let madhabShafii = "settings.madhab.shafii"
    static let madhabShafiiArabic = "settings.madhab.shafiiArabic"
    static let madhabShafiiDescription = "settings.madhab.shafiiDescription"
    static let madhabHanbali = "settings.madhab.hanbali"
    static let madhabHanbaliArabic = "settings.madhab.hanbaliArabic"
    static let madhabHanbaliDescription = "settings.madhab.hanbaliDescription"
    static let madhabLoadFailed = "settings.madhab.loadFailed"
    static let madhabUpdateFailed = "settings.madhab.updateFailed"
    static let madhabSelectAccessibility = "settings.madhab.selectAccessibility"
    ...
    static let donate = "settings.donate"
    static let donateMonthly = "settings.donate.monthly"
    static let donateYearly = "settings.donate.yearly"
    static let donateAmount1 = "settings.donate.amount.1"
    static let donateAmount5 = "settings.donate.amount.5"
    static let donateAmount10 = "settings.donate.amount.10"
    static let donateAmount100 = "settings.donate.amount.100"
    static let donateSheetTitle = "settings.donate.sheet.title"
    static let donateSheetSubtitle = "settings.donate.sheet.subtitle"
    static let donateFooter = "settings.donate.footer"
    static let donateRestore = "settings.donate.restore"
    static let donateSuccessTitle = "settings.donate.success.title"
    static let donateSuccessMessage = "settings.donate.success.message"
    static let donateLoadFailed = "settings.donate.loadFailed"
    static let donatePaymentsDisabled = "settings.donate.paymentsDisabled"
    static let donateCurrent = "settings.donate.current"
    static let donateCurrentStatus = "settings.donate.currentStatus"
    ...
    static let authForgotPassword = "auth.forgotPassword"
    static let authForgotPasswordEmailRequired = "auth.forgotPassword.emailRequired"
    static let authForgotPasswordSent = "auth.forgotPassword.sent"
