...
fun RequestCameraPermission(
    ...
    PermissionHandler(
        ...
        rationaleMessage = "Camera permission is required to take photos. This allows you to capture images containing text for OCR.",
        onPermissionResult = onPermissionResult
    )
}

/**
 * Composable to request storage/media permission.
 */
@Composable
fun RequestStoragePermission(
    ...
    PermissionHandler(
        ...
        rationaleMessage = "Storage permission is required to access photos from your gallery. This allows you to select images containing text for OCR.",
        onPermissionResult = onPermissionResult
    )
}
