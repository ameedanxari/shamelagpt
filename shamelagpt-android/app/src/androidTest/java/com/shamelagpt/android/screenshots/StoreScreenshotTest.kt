...
class StoreScreenshotTest {
    ...
    private fun mockSettingsViewModel(locale: String): com.shamelagpt.android.presentation.settings.SettingsViewModel {
        ...
        val promptFlow = MutableStateFlow(
            when (locale) {
                "ar" -> "قدّم خلاصة عملية أولاً.\nثم اذكر الدليل من كتب التراث مع التنبيه على صحة الحديث عند الحاجة."
                "ur" -> "پہلے عملی خلاصہ دیں۔\nپھر معتبر کتب کے حوالہ جات کے ساتھ مختصر توضیح پیش کریں۔"
                else -> "Start with a practical summary first.\nThen cite classical sources and note hadith grading when relevant."
            }
        )
            ...
            com.shamelagpt.android.domain.model.Conversation(
                ...
                messages = listOf(
                    Message(
                        id = "1-preview",
                        content = when (locale) {
                            "ar" -> "الفرق بين العلامات الصغرى والكبرى باختصار."
                            "ur" -> "صغریٰ اور کبریٰ علامات میں مختصر فرق۔"
                            else -> "Quick distinction between minor and major signs."
                        },
                        isUserMessage = true,
            ...
            com.shamelagpt.android.domain.model.Conversation(
                ...
                messages = listOf(
                    Message(
                        id = "2-preview",
                        content = when (locale) {
                            "ar" -> "خطوات الوضوء مع أكثر الأخطاء شيوعًا."
                            "ur" -> "وضو کے مسنون مراحل اور عام غلطیاں۔"
                            else -> "Sunnah wudu sequence and common mistakes."
                        },
                        isUserMessage = false,
